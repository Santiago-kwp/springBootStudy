...
VALUES ('야간등반', '/img/001.jpg', 1000000, 5,
        ...
        '밤하늘의 별빛을 나침반 삼아 오르는 고독한 여정. 헤드랜턴 불빛 아래 드러난 바위의 질감과 그 위를 수놓는 은하수의 대조가 인상적인 작품입니다. 미지의 세계를 탐험하는 용기를 표현합니다.')
     , ('겨울산', '/img/002.jpg', 2000000, 10,
        '침묵하는 설산의 웅장함, 고결한 아름다움.',
        '침묵하는 설산의 웅장함과 순수함이 느껴지는 풍경입니다. 차가운 공기 속에 뼈대만 남은 나무들과 칼바람을 견뎌낸 봉우리의 고결한 아름다움을 담아냈습니다. 인내와 경외심의 순간.')
     , ('완등후', '/img/003.jpg', 3000000, 15,
        '도전의 끝에서 느끼는 해방감과 평화.',
        '마침내 정상에 섰을 때의 해방감과 성취감을 포착한 작품입니다. 발아래 펼쳐진 세상과 땀방울이 마르는 순간의 희열이 담겨 있습니다. 도전의 끝에서 느끼는 평화.')
     , ('절벽등반', '/img/004.jpg', 4000000, 20,
        '수직 절벽을 오르는, 생명을 건 극한의 집중력.',
        '수직으로 깎아지른 아찔한 절벽을 오르는 클라이머의 강인한 의지를 담았습니다. 생명을 건 몸짓과 거대한 자연 앞에서 인간이 보여줄 수 있는 극한의 집중력을 표현합니다.')
     , ('멀티등반', '/img/005.jpg', 5000000, 25,
        '신뢰와 협동, 로프 하나에 의지하는 팀워크.',
        '두 명의 클라이머가 한 팀이 되어 여러 피치(Pitch)를 오르는 역동적인 순간을 담았습니다. 신뢰와 협동, 그리고 로프 하나에 의지하는 팀워크의 중요성을 상징하는 작품입니다.')
     , ('멀티등반2', '/img/006.jpg', 6000000, 30,
        '장엄한 역광 속, 고전적인 암벽 등반의 미학.',
        '장엄한 스케일의 암벽에서 펼쳐지는 두 번째 피치의 모습입니다. 역광 속에서 실루엣으로 처리된 클라이머의 모습이 더욱 드라마틱하고 고전적인 암벽 등반의 미학을 전달합니다.')
     , ('렛서팬더등반', '/img/007.jpg', 7000000, 45,
        '자연의 유머, 끈기 있는 렛서팬더의 발바닥처럼.',
        '자연의 순수함과 예상치 못한 유머가 결합된 작품입니다. 렛서팬더의 발바닥 패드처럼 끈기 있게 바위를 짚는 등반가의 모습을 익살스럽게 재해석했습니다. 경쾌한 도전 정신.')
     , ('고양이등반', '/img/008.jpg', 2000000, 55,
        '고양이처럼 우아한 유연성, 균형의 미학.',
        '유연하고 우아한 고양이의 움직임처럼, 최소한의 힘으로 바위를 타고 오르는 클라이머의 자세를 표현합니다. 균형과 유연성의 미학, 무중력 상태를 거스르는 듯한 섬세함.')
     , ('자연속건물', '/img/009.jpg', 3000000, 65,
        '도심 속 구조물에서 발견하는 새로운 형태의 탐험.',
        '자연 암벽이 아닌 도심 속 버려진 구조물을 등반하는 모습을 담았습니다. 현대 건축물과 거친 자연 환경이 만나는 지점에서 새로운 형태의 등반 예술을 발견합니다. 도시 속의 탐험.')
     , ('맨손등반', '/img/010.jpg', 2000000, 80,
        '손끝과 바위의 마찰, 본능적인 도전의 순간.',
        '어떠한 장비 없이 오직 손끝과 발끝의 감각에 의존하는 클라이머의 맨몸을 클로즈업한 작품입니다. 거친 바위와 피부의 마찰이 생생하게 느껴지며, 본능적인 도전을 담아냅니다.')
     , ('자연암벽', '/img/011.jpg', 4000000, 32,
        '억겁의 시간이 빚은 암벽 앞에서 겸손해지는 모습.',
        '억겁의 시간 동안 바람과 물이 조각한 순수한 자연 암벽의 위용을 담았습니다. 자연이 빚어낸 홀드(Hold)와 지형의 아름다움, 그리고 그 앞에서 겸손해지는 인간의 모습을 대조합니다.')
     , ('붉은암벽', '/img/012.jpg', 5000000, 50,
        '석양의 빛과 그림자가 만드는 강렬한 암벽 드라마.',
        '석양이 질 무렵, 모든 것을 태울 듯 붉게 물든 거대한 암벽의 표정을 포착했습니다. 하루의 마지막 빛과 등반가의 그림자가 만나 만들어내는 강렬한 드라마가 인상적입니다.')
     , ('겨울암벽', '/img/013.jpg', 8000000, 60,
        '얼음과 눈 속, 극한의 환경에서 피어나는 생명력.',
        '차가운 얼음과 눈에 뒤덮인 암벽을 오르는 아이스 클라이밍의 순간입니다. 날카로운 장비와 얼음의 투명함이 대조를 이루며, 극한의 환경에서 피어나는 생명력과 집중력을 표현합니다.')
;
select * from items;
